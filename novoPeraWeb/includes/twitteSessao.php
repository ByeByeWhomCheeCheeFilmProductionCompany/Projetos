<?php
    ...
    $linkPeraWebCat = 'http://empregos.peraweb.com.br/'.$user;


    $return = json_decode(file_get_contents('http://empregos.peraweb.com.br/json-to-rss/jsons/secao-'.$user.'.json'));
    ...
    foreach ($secao as $k =>$line){
        ...
        $linkPeraWebSec = 'http://empregos.peraweb.com.br/'.$slug_geral.'/'.$line->user->screen_name;

        $linkPeraWeb = 'http://empregos.peraweb.com.br/'.$slug_geral.'/'.$line->user->screen_name.'/'.$line->id.'/'.removeAcentos($line->text,'-');
