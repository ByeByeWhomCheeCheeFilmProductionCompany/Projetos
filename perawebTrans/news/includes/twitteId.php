...
echo '</pre>-->';
                            ...
                            $linkPeraWebSec = 'http://news.peraweb.com.br/'.$slug_geral.'/'.$line->user->screen_name;

                            $linkPeraWeb = 'http://news.peraweb.com.br/'.$slug_geral.'/'.$line->user->screen_name.'/'.$line->id.'/'.removeAcentos(preg_replace("/(http:\/\/)(.*?)\/([\w\.\/\&\=\?\-\,\:\;\#\_\~\%\+]*)/", "",$line->text),'-');
                                        ...
                                        echo '<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
                                            ...
                                            <a class="btn btn-social-icon btn-facebook btn-lg" rel="prettyPhoto[iframes]" title="Google.com opened at 100%" href="https://www.facebook.com/sharer/sharer.php?u=http://news.peraweb.com.br/'.$slug_geral.'/'.$line->user->screen_name.'/'.$line->id.'/'.$line->text.'&iframe=true&width=500&height=250" target="_blank"><i class="fa fa-facebook"></i></a>

                                            <a class="btn btn-social-icon btn-google-plus btn-lg" rel="prettyPhoto[iframes]" title="Google.com opened at 100%" href="https://plus.google.com/share?url=http://news.peraweb.com.br/'.$slug_geral.'/'.$line->user->screen_name.'/'.$line->id.'/'.$line->text.'&iframe=true&width=500&height=250" target="_blank"><i class="fa fa-google-plus"></i></a>

                                            <a class="btn btn-social-icon btn-twitter btn-lg" rel="prettyPhoto[iframes]" title="Google.com opened at 100%" href="https://twitter.com/intent/tweet?text=http://news.peraweb.com.br/'.$slug_geral.'/'.$line->user->screen_name.'/'.$line->id.'/'.$line->text.'&iframe=true&width=500&height=250" target="_blank"><i class="fa fa-twitter"></i></a>
...
echo '<div class="row col-lg-12"><h2 class="page-header secao text-capitalize">Mais de '.$line->user->name.'</h2></div><br><div class="col-lg-12 tab-content"></a>';
    ...
    //$linkPeraWebCat = 'http://news.peraweb.com.br/'.$user;

    $return = json_decode(file_get_contents('http://news.peraweb.com.br/json-to-rss/jsons/secao-'.$user.'.json'));
                                ...
                                <div class="thumbnail" style="overflow:hidden;padding:0;">
                                    ...
                                    echo '
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a class="btn btn-social-icon btn-facebook" rel="prettyPhoto[iframes]" title="Google.com opened at 100%" href="https://www.facebook.com/sharer/sharer.php?u=http://news.peraweb.com.br/'.$slug_geral.'/'.$line->user->screen_name.'/'.$line->id.'/'.$line->text.'&iframe=true&width=500&height=250" target="_blank"><i class="fa fa-facebook"></i></a>

                                            <a class="btn btn-social-icon btn-google-plus" rel="prettyPhoto[iframes]" title="Google.com opened at 100%" href="https://plus.google.com/share?url=http://news.peraweb.com.br/'.$slug_geral.'/'.$line->user->screen_name.'/'.$line->id.'/'.$line->text.'&iframe=true&width=500&height=250" target="_blank"><i class="fa fa-google-plus"></i></a>

                                            <a class="btn btn-social-icon btn-twitter" rel="prettyPhoto[iframes]" title="Google.com opened at 100%" href="https://twitter.com/intent/tweet?text=http://news.peraweb.com.br/'.$slug_geral.'/'.$line->user->screen_name.'/'.$line->id.'/'.$line->text.'&iframe=true&width=500&height=250" target="_blank"><i class="fa fa-twitter"></i></a>
