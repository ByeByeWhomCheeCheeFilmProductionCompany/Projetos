...
$return = json_decode(file_get_contents('http://empresas.peraweb.com.br/json-to-rss/jsons/lista.json'));
$canal = ($usage == 'hashtag') ? $return->statuses : $return;

foreach ($canal as $line){

    $return = json_decode(file_get_contents('http://empresas.peraweb.com.br/json-to-rss/jsons/canal-'.$line ->slug.'.json'));;
