<?php
    ...
    foreach ($secao as $k =>$line){
        ...
        echo '<div class="row col-lg-12  '.$slug_geral.'"><h1 class="page-header secao text-capitalize"><a href="http://news.peraweb.com.br/'.$slug_geral.'">'.$slug_geral.'</a> / '.$user.'</h1></div><div class="row col-lg-12"></a>
