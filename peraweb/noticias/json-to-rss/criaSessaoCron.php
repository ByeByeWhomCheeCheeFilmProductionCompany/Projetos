...
$return = json_decode(file_get_contents('http://noticias.peraweb.com.br/json-to-rss/jsonsCron/lista.json'));
$canal = ($usage == 'hashtag') ? $return->statuses : $return;

foreach ($canal as $line){

    $return = json_decode(file_get_contents('http://noticias.peraweb.com.br/json-to-rss/jsonsCron/canal-'.$line ->slug.'.json'));;
